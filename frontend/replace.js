const fs = require('fs');
const filepath = "C:/Aamin02/aamin01/frontend/src/app/(public)/hire-ambulance/page.tsx";

const wholeFileString = `'use client'
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 md:p-8 rounded shadow border border-gray-200 space-y-8">
          ...
          <section>
            ...
            {watchedIsPatient === 'NO' && (
              <div className="space-y-6">
                <div>
                  <h3 className="font-semibold text-gray-700 mb-3 underline">👤 Caller Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      <label className="block mb-1 font-medium text-gray-700">Caller Phone Number*</label>
                      <input {...register('callerPhone')} className="w-full border border-gray-300 p-2 rounded outline-none focus:border-blue-500" required />
                    </div>
                    <div className="md:col-span-2">
                      <label className="block mb-1 font-medium text-gray-700">Relationship to Patient*</label>
                      <select {...register('callerRelationship')} className="w-full md:w-1/2 border border-gray-300 p-2 rounded bg-white outline-none focus:border-blue-500" required>
                ...
                <div>
                  <h3 className="font-semibold text-gray-700 mb-3 underline">🧍 Patient Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      <label className="block mb-1 font-medium text-gray-700">Patient Name*</label>
                      <input {...register('patientName')} className="w-full border border-gray-300 p-2 rounded outline-none focus:border-blue-500" required />
          ...
          {/* STEP 7: Final */}
          <section>
            <h2 className="text-lg font-bold mb-3 border-b pb-1 text-gray-800">⚙️ STEP 7: Final</h2>
...
`
fs.writeFileSync(filepath, wholeFileString);
console.log("File completely overwritten with 7-step logic");

  ...
  ({ className, checked, onCheckedChange, ...props }, ref) => {
    return (
      ...
      >
        ...
        />
        {checked && (
          <span className="absolute left-1.5 text-[8px] font-bold text-white uppercase select-none">ON</span>
        )}
        {!checked && (
          <span className="absolute right-1 text-[8px] font-bold text-slate-400 uppercase select-none">OFF</span>
        )}
      </button>
    )
  }
